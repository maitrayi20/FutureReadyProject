...
<body>
    ...
    <div class="main">
        <?php
            echo '<p>Number of Classes Listed :'.$no_of_classes[0].'</p>';
            echo '<p>Number of Students Admitted :'.$no_of_students[0].'</p>';
            echo '<p>Number of Results Declared :'.$no_of_result[0].'</p>';
        ?>
    </div>
